...
# Embeddings models in CentaurOps
...
:::note
This component is deprecated as of CentaurOps version 1.0.18.
...
To use this component in a flow, connect CentaurOps to your locally running Ollama server and select an embeddings model.
