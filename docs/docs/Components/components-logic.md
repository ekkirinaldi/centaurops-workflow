...
# Logic components in CentaurOps
...
This is represented in CentaurOps by connecting the Parser component's **Data List** output to the Loop component's `Data` loop input.
...
Follow along with this step-by-step video guide for creating this flow and adding agentic RAG: [Mastering the Loop Component & Agentic RAG in CentaurOps](https://www.youtube.com/watch?v=9Wx7WODSKTo).
...
This component allows you to run any flow stored in your CentaurOps database without opening the flow editor.
...
:::important
This component is in **Legacy**, which means it is no longer in active development as of CentaurOps version 1.3.
:::
...
:::important
This component is deprecated as of CentaurOps version 1.1.2.
