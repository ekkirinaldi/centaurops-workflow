...
async def check_langflow_version(component: StoreComponentCreate) -> None:
    ...
    if langflow_version is None:
        raise HTTPException(status_code=500, detail="Unable to verify the latest version of CentaurOps")
    if langflow_version != component.last_tested_version:
        logger.warning(
            f"Your version of CentaurOps ({component.last_tested_version}) is outdated. "
